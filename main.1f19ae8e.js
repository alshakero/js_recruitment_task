...
exports.removeAllNodeChildren = removeAllNodeChildren;
exports.calculateAndFormatLastMonthDate = calculateAndFormatLastMonthDate;
...
var API_KEY = '0799ee2a-183d-4acf-82a7-9379bf638615';
/**
...
function calculateAndFormatLastMonthDate() {
  var date = new Date(Date.now() - 2.628e9); // 2.628e+9 is a month in ms
...
function constructAPIEndpoint() {
  ...
  var section = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : defaultSectionsParam;
  var date = calculateAndFormatLastMonthDate();
  return "https://content.guardianapis.com/search?section=".concat(section, "&order-by=newest&api-key=").concat(API_KEY, "&q=").concat(query, "&page=").concat(page, "&from-date=").concat(date);
}
/**
...
function fetchFromAPI(_x, _x2, _x3) {
...
function _fetchFromAPI() {
  _fetchFromAPI = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(page, query, section) {
    var url, result, json;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            url = constructAPIEndpoint(page, query, section);
            _context.next = 3;
            return fetch(url);
          ...
          case 6:
            json = _context.sent;
            return _context.abrupt("return", json.response);
...
function debounce(origialFunction, duration) {
  var timeoutRef;
  return function () {
    clearTimeout(timeoutRef);
    timeoutRef = setTimeout.apply(void 0, [origialFunction, duration].concat(Array.prototype.slice.call(arguments)));
  };
}
},{}],"readLaterStore.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderAllReadLaterStories = renderAllReadLaterStories;
exports.injectReadLaterStory = injectReadLaterStory;
...
var readLaterStoriesStore = loadReadLaterStories();
/** The `ul` where read-later stories are rendered */

var readLaterListUL = document.querySelector('.readLaterList');
/**
 * Renders all stories stored in readLaterStoriesStore
 */

function renderAllReadLaterStories() {
...
function saveReadLaterStories() {
  localStorage.setItem(LOCAL_STORAGE_KEY, JSON.stringify(readLaterStoriesStore));
}
/**
...
function injectReadLaterStory(story, originalStoryElement) {
  var id = story.id,
      webTitle = story.webTitle,
      webUrl = story.webUrl; // make sure the story isn't already added

  var index = readLaterStoriesStore.findIndex(function (story) {
    return story.id === id;
  });

  if (index < 0) {
    readLaterStoriesStore.push({
      id: id,
      webTitle: webTitle,
      webUrl: webUrl
    });
    var rendered = renderReadLaterStory({
      id: id,
      webTitle: webTitle,
      webUrl: webUrl
    });
    ...
    */
    ...
    var readLaterElementRect = rendered.getBoundingClientRect();
    ...
    // add highlight class
    readLaterListUL.children[index].classList.add('highlighted'); // scroll to the highlighted story if needed
    ...
    setTimeout(function () {
      return readLaterListUL.children[index].classList.remove('highlighted');
    }, 500);
  }
}
/**
...
function removeReadLaterStory(storyId) {
  var index = readLaterStoriesStore.findIndex(function (s) {
    return s.id === storyId;
  });
...
function renderReadLaterStory(_ref) {
  var id = _ref.id,
      webTitle = _ref.webTitle,
      webUrl = _ref.webUrl;
  var HTML = "\n          <h4 class=\"readLaterItem-title\">".concat(webTitle, "</h4>\n          <section>\n              <a rel=\"noopener noreferrer\" target=\"_blank\" href=\"").concat(webUrl, "\" class=\"button button-clear\">Read</a>\n              <button class=\"removeButton button button-clear\">Remove</button>\n          </section>\n      ");
  var li = document.createElement('li');
  li.innerHTML = HTML;
  li.className = 'readLaterItem';
  li.querySelector('section .removeButton').addEventListener('click', function () {
    return removeReadLaterStory(id);
  });
  return li;
}
...
var _readLaterStore = require("./readLaterStore");
...
var networkErrorMessage = "Sorry. Couldn't reach the Guardian API due to a connection issue. Please try again later.";
var noItemsErrorMessage = "There isn't any news stories matching the current criteria published after ".concat((0, _utils.calculateAndFormatLastMonthDate)(), " (in the last month).");
/** The `ul` where stories are rendered  */

var storiesListUL = document.querySelector('.newsList');
/** the pagination `select` element */

var pageSelect = document.querySelector('#activePageSelect');
/** the search query `input` */

var searchInput = document.querySelector('#newsContentSearch');
/** the section `select` element */

var sectionSelect = document.querySelector('#sectionSelect');
/** the required sections encoded URI param */

var defaultSectionsParam = encodeURIComponent("(".concat(['sport', 'books', 'business', 'culture'].join('|'), ")"));
/**
...
function renderStory(story) {
  var HTML = "\n        <article class=\"news\">   \n            <header>\n                <h3>".concat(story.webTitle, "</h3>\n            </header>\n            <section class=\"newsDetails\">\n            <ul>\n                <li><strong>Section Name:</strong> ").concat(story.sectionName, "</li>\n                <li><strong>Publication Date:</strong> ").concat(new Date(story.webPublicationDate).toLocaleDateString('en-GB'), "</li>\n            </ul>\n            </section>\n            <section class=\"newsActions\">\n                <a rel=\"noopener noreferrer\" target=\"_blank\" href=\"").concat(story.webUrl, "\" class=\"button\">Full article</a>\n                <button class=\"button button-outline\">Read Later</button>\n            </section>\n        </article>\n    ");
  var li = document.createElement('li');
  li.className = 'newsItem';
  li.innerHTML = HTML;
  li.querySelector('.newsActions .button.button-outline').addEventListener('click', function () {
    return (0, _readLaterStore.injectReadLaterStory)(story, li);
  });
  return li;
}
/**
...
function _fetchArticles() {
  _fetchArticles = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee() {
    var page, query, sections, _ref, results, total, renderedStories;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            sections = sectionSelect.value === 'all' ? defaultSectionsParam : sectionSelect.value;
            _context.prev = 3;
            _context.next = 6;
            return (0, _utils.fetchFromAPI)(page, query, sections);
          ...
          case 6:
            ...
            hideErrorMessage(); // remove already rendered stories

            (0, _utils.removeAllNodeChildren)(storiesListUL);

            if (total > 0) {
              renderedStories = results.map(renderStory);
              renderedStories.forEach(storiesListUL.appendChild, storiesListUL);
            } else {
              // no stories for this criteria
          ...
          case 14:
            ...
            console.error(_context.t0); // log for easy debugging
